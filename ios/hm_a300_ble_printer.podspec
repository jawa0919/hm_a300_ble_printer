...
# Run `pod lib lint hm_a300_ble_printer.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
  s.name             = 'hm_a300_ble_printer'
  s.version          = '0.0.1'
  s.summary          = 'https://www.hprt.com.cn/search_keywork.html?search_key=HM-A300&search_num=21'
  s.description      = <<-DESC
